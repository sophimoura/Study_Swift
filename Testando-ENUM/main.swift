//TESTANDO ENUM: : tentar trocar o formato String da classe LivroDigital pra um tipo customizado feito com Enum
...
class LivroDigital: livro {
    var formato: FormatoDoLivro //Propriedade armazenada
    
    init(titulo: String, autor: String, generos: [String], formato: FormatoDoLivro, nPag: Int) {
    ...
    override func descricao() -> String {
        return "O livro \(titulo) foi escrito por \(autor) e o formato dele é \(formato)"
    }
...
// Exemplo de uso:
let livroDigital = LivroDigital(titulo: "Dom Casmurro", autor: "Machado de Assis", generos: ["Romance", "Conto", "Crônica", "Novela", "Poema","Terror"], formato: .Fisico, nPag: 200)
