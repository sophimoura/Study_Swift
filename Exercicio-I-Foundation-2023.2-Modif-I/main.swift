...
// Exemplo de uso:
let livroDigital = LivroDigital(titulo: "Dom Casmurro", autor: "Machado de Assis", generos: ["Romance", "Conto", "Crônica", "Novela", "Poema"], formato: "Físico", nPag: 200)
...
print("Me dê exemplos de gêneros que começam com a letra:\(livroDigital.generosComA(letra: "R"))")